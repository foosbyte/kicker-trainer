...
export const Editor = inject('exerciseCatalogue')(
  observer(
              ...
              {Object.keys(Bars).reduce(
                (bars, bar) => [
                  ...
                  ...(this.props.exerciseCatalogue.data as any)[
                    ...
                    const exercise = this.props.exerciseCatalogue.getExercise(
                      id
                    );
                    if (!exercise) {
...
const ExerciseEditor = inject('exerciseCatalogue')(
  observer(
