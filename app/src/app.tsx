            ...
            <DataPrivacyLayer>
              <Space between="m">
                <Text>
                  ...
                  Inhalte und Werbung. Indem Sie diese Website nutzen, erklären
                  Sie sich mit dieser Verwendung einverstanden.
                </Text>
                <Button
                  onPress={this.acceptDataPrivacyAgreement}
                  intent="default"
                >
                  Akzeptieren
                </Button>
